...
var CONTACT_PAGE = {
  ...
  seo: {
    ...
    description:
      "عنوان العيادة، رقم التواصل، وطرق الوصول لد. طاهرة پوردست في شيراز. الحجز عبر الإنترنت من خلال Doctoreto وAxon.",
  ...
  hero: {
    ...
    description:
      "عنوان العيادة، رقم التواصل، والخريطة متاحة في هذه الصفحة. للحجز عبر الإنترنت، استخدمي منصتي Doctoreto أو Axon.",
    ...
    items: [
      {
        ...
        answer:
          "يُجرى الحجز عبر الإنترنت من خلال منصتي Doctoreto أو Axon. يأخذك زر «حجز موعد» في أعلى الصفحة إلى صفحة الحجز الرسمية.",
      },
      {
        id: "site-booking",
        question: "هل يمكن الحجز من خلال هذا الموقع؟",
        answer:
          "لا. هذا الموقع مخصص للتعريف بالخدمات وتقديم معلومات عامة. يُجرى الحجز عبر منصتي Doctoreto أو Axon.",
      },
      {
        id: "first-visit-docs",
  ...
  finalCta: {
    ...
    description: "يُجرى الحجز عبر الإنترنت من خلال Doctoreto أو Axon.",
    cta: {
