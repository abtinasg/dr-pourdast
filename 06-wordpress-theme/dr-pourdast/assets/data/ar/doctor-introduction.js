...
var DOCTOR_INTRODUCTION = {
  ...
  biography: [
    ...
    "تعمل أستاذة مشاركة في جامعة شيراز للعلوم الطبية، وإلى جانب عملها العلاجي تُشارك في التعليم والبحث. يقوم نهجها على التقييم الدقيق واختيار أقل الطرق توغلاً للعلاج.",
  ],
  ...
  credentials: [
    ...
    {
      title: "أستاذة مشاركة في جامعة شيراز للعلوم الطبية",
