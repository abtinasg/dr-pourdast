...
var DOCTOR_INTRODUCTION = {
  ...
  biography: [
    ...
    "ایشان دانشیار دانشگاه علوم پزشکی شیراز بوده و در کنار فعالیت درمانی، در زمینه آموزش و پژوهش بیماری‌های زنان نیز فعالیت دارد. رویکرد درمانی ایشان بر ارزیابی دقیق شرایط بیمار و انتخاب کم‌تهاجمی‌ترین روش درمان استوار است.",
  ],
