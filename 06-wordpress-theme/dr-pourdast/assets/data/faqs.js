...
var FAQ_SECTION = {
  ...
  items: [
    ...
    },
    {
      ...
      answer:
        "ویزیت مستقیم توسط خانم دکتر طاهره پوردست در سامانه اکسون ثبت می‌شود؛ در اکسون امکان نوبت ویزیت و سونوگرافی نیز وجود دارد. نوبت‌دهی در سامانه دکترتو معمولاً زودتر انجام می‌شود چون توسط همکاران ایشان انجام می‌گیرد و با خانم دکتر مشورت می‌شود؛ در صورت نیاز به عمل جراحی، خود ایشان انجام می‌دهند. ویزیت توسط همکاران به تسریع روند درمان بیماران کمک می‌کند. دکمه «رزرو نوبت» شما را به سامانه اکسون هدایت می‌کند.",
