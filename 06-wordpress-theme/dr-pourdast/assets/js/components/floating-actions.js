...
var BACK_TO_TOP_ICON =
  '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 6L12 18M12 6L7 11M12 6L17 11" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>';
...
function getWhatsAppUrl() {
  ...
  if (!SITE_CONFIG.clinicPhone) return null;

  var digits = String(SITE_CONFIG.clinicPhone).replace(/\D/g, "");
...
/**
 * Inserts floating action buttons at the end of the body.
 */
function initFloatingActions() {
  ...
  if (backToTopButton) {
    initBackToTopButton(backToTopButton);
  }
}
