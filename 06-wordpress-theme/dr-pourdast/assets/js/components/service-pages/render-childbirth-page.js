...
(function () {
  ...
  mount.outerHTML =
    ...
    renderMethodComparison(data.deliveryMethods) +
    renderServiceProcess(data.prenatalCare) +
    renderBenefitsLimitations(data.considerations) +
