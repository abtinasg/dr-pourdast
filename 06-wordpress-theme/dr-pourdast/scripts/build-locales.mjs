...
const TEXT_REPLACEMENTS = {
  en: {
    ...
    "مشاهده نوبت‌های آزاد در دکترتو": "View appointments on Doctoreto",
    "مشاهده نوبت‌های آزاد": "View appointments",
  ...
  ar: {
    ...
    "مشاهده نوبت‌های آزاد در دکترتو": "عرض المواعيد المتاحة في Doctoreto",
    "مشاهده نوبت‌های آزاد": "عرض المواعيد المتاحة",
